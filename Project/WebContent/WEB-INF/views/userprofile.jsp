...
<link rel="stylesheet" type="text/css" id="" href="<c:url value="/resources/css/bootstrap-4.1.1.min.css"/>">
...
<script type="text/javascript">
	...
	var password_must_contain_at_least_one_letter_and_one_digit = '<spring:message code="password_must_contain_at_least_one_letter_and_one_digit" />';
	...
	function changePassword(){
		...
		if ( alphanumericRegex.test(newPassword)){
			if(newPassword == confirmNewPassword && newPassword.length>=8){
				...
				$("#passwordErrorMessage").html(field_are_empty);
			}else if ( (newPassword != confirmNewPassword) && newPassword != ''){
				$("#passwordErrorMessage").html(password_not_match);
			}		
		}
		else{
					...
					<div class="row textAlignRight">
                                            ...
                                            <div class="col-md-5">
                                              <p class="ptext">${userProfileDetials.organizationUnitName}</p>
                                                <input value="${userProfileDetials.organizationUnitName}" type="text" class="form-control inputtext orgnizational_unit_name" readonly></input>
                                            </div>
                                        </div>
                            </div>
