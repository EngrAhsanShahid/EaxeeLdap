...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="" href="<c:url value="/resources/css/dataTables.bootstrap4.min.css"/>">
...
<!-- 	 <script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script> -->
	...
	<script>
		...
		var save_chart_first = '<spring:message code="save_chart_first" />';
		...
		var all_fields_are_required = '<spring:message code="all_fields_are_required" />';
		var associated_architecture_cap = '<spring:message code="associated_architecture_cap" />';
...
<div id="dialog-confirm" title="<spring:message code="confirm_delete"/>" style="display:none">
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span><spring:message code="you_are_about_to_delete"/> <b><i class="title"></i></b> <spring:message code="page_this_procedure_is_irreversible"/></p>
</div>
...
<!-- 				<a href="home"> -->
			...
			<div>
				<span class="showArchitectureTitle"></span>
			</div>
...
<!-- 			<!-- ///////////////////////////////////////////////////////// -->
	...
	<div class="navbar" style="background:#0d7e8a; width:100%;height:55px; padding-left:0px">
		<div id="element_title">
<!-- 			<span id="element_title"></span> -->
		</div>
		
		<div id="alert_message_parent">	
	    	<span class="alert_message" style="text-align: center; padding: 0px !important; height: 40px; margin: auto;"></span>
		</div>	
		<div >
...
<!-- 		<div class="chartDiv" style="background:#FFFFFF !important;zoom:75%;"> -->
		<div class="chartDiv" style="background:#FFFFFF !important;">
			<div id="dialog" title="<spring:message code="Page"/>">
				<form>
					<fieldset class="ui-helper-reset">
						 
						<input type="text"
							name="tab_title" id="tab_title" placeholder="<spring:message code="Page" />"
							class="ui-widget-content ui-corner-all form-control required" onkeydown="return (event.keyCode!=13);"> 
					    <label for="tab_title"><spring:message code="Associated_to" /></label>
					      <!-- Add a dropdown menu -->
				      	<select name="OPArchitectureDropdownValue" id="organizationalPortalArchitectureDropdown" class="form-control">
