...
function updateFormModal(cellValue,elementName,cell,route,r_id,architectureId){
	...
	//}
	  ...
	  $.ajax({
		...
		success: function(data) {
			...
			form_submitForUpdate(dbName, tableName, labels, idd,allIds,row_name,AllRelRowIDs,btnedit, object_name_id, imageName, current_ID,CurrenttabID[0], cell, last_time_updated, AllRelTableIDs, dataBeforeUpdate, route, architectureId, null, null);
