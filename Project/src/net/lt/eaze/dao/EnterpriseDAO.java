...
//	public int testFiling(String r);
	...
	List<String> getRows1ForImpex(String dbName, String tableName, String attrName, String architechtureId);
	...
	int savegraphjson(String json_graph, String username, String graphname, String graphID,String idsToNameDict);
	
	int savenavigationjson(String json_graph, String username, String navigationname, String navigationID,String idsToNameDict,String tooltipDict,String contextMenuMultipleRelationsDict);
	
	String getGraph(String dbName, String username, String graphID, String company_name);
//	int addRelationsFromXML_Method1(addRelationsFromXML r, String fromTable, String toTable);
	...
	int addRelationsFromGraph(RelationsModel r,String architectureId);
	...
	int delRowDataFromTree(String dbName, String tableName, String attributeName, String architectureId);
	...
	public int createNewModelFile(String id, String company_name,String username, String graphname,String graph_json,String architectureId);
	...
	String validateObjectName(String dbName, String tableName, String object_name,String oldName, String architecture_id);
	
	String validateModelName(String modelName, String username,String parentID);
...
//	List<attributesInformationModel> getAllAttributeDetails(String dbName, String elementName);
	...
	int addRowsForObject(fromExcel r, String username, String repositoryID);
...
public List<attributesInformation> attList(String dbName, String attTable, String tableName);
	...
	int saveMatrixIntoDB(String matrix_name, String matrix_element1, String matrix_element2, String matrix_relation,
			String parentID,String username, String allRelations,String architecture_id,String companyName);
...
//			int conditionValue);
	...
	public List<RelationsModel> getRelationshipTableForImpex(String dbName, String replaceAll, String tableName, String architechtureId);

	Map<String, String> impexInsertElements(String dbName, String tableName, List<String> columnNames, List<ArrayList<String>> elementValues, String username, HttpSession session, Schema unif, Map<String, String> objectNameToObjectId);
...
//	Get database backup ends here	
	...
	public String validateCatalogName(String catalog_name, String username, String parentID);

	public int validateMatrixName(String matrix_name, String username, String parentID);
	...
	public int createNewNavigationFile(String id, String replaceAll, String username, String navigationName,String graph_json,String architectureId);
...
//	public List<navigationFiles> getNavigationFromFolder(String username, String id1, String string);
	...
	public ArrayList<HashMap<String, String>> getFolderNameFromDatabase(String username, String company_name);
...
//	public List<String> getChartTableData(String dbName, String elementName, String attributeValue);
	...
	HashMap<String, List<String>> filterDiagramRelationships(String dbName, String userSelectedElementName, List<String> userSelectedObjects, List<String> userSelectedObjectsColor, List<String> openedDiagramElementName, List<String> openedDiagramObjectName, Map<String, String> objectNameToId, Map<String, String> objectIdToName);
	...
	int createNewModelFileForFilteredDiagram(String foreign_key, String company_name, String username, String graphname, String graph_json, String isFiltered, String filteredDetails, String architectureId,String idsToNameDict);
	...
	List<String> checkBusinessProcessStatus(String username, String company_name);

	int updateRelationshipObjectValues(String dbName, String tableName, String fromColumn, String toColumn,
			String fromObject, String toObject, String newObjAtt, String newFromAtt, String newToAtt, String newObjName,
			String newFromVal, String newToVal);
	
	String checkChartStatus(String chartDivName, String username);

	int createSessionActiveUserTable(String sessionId,String username);

	int updateSessionActiveUserTable(String sessionId,String username);
	
	List<String> selectActiveSessionID(String username);
	
	int deleteSessionActiveRow(String id);	
	int createElementTable(tableModel p);

	List<String> getRowsWithInCondtion(String dbName, String tableName, String ids, String attName);

	public List<String> getIdByObjectName(String dbName, String destination, String splittedRelObjName);

	List<ArrayList<String>> getCompleteTableWithIdColumnsBySGVArray(String dbName, String tableName, List<String> ElementSGV, String architechtureId);

	List<String> getObjectIdByObjectName(String dbName, String tableName, String objectName,String architectureID);

	List<Integer> getObjectCountInRelationshipTable(String dbName, String objectID, String tableName, String brCode);

	List<String> getObjectNameByObjectId(String dbName, String tableName, String objectId);

	HashMap<String, String> getObjectIdsByObjectNameOfMultipleObjects(String dbName, String tableName, List<String> objectNames);

	public void createArchitectureDB(String dbName, String tableName, String architectureName) throws SQLException;
	...
	ArrayList getAllRepositories(String dbName, String tableName);

	HashMap<String, ArrayList<HashMap<String, String>>> getRowsWithTypesAndArchitectureID(String dbName, String tableName,String nameAttributeSGV, String typeAttributeSGV, String architectureID);

	ArrayList<HashMap<String, String>> getRowsWithArchitectureID(String dbName, String tableName, String attrName, String architectureID);

	public List<Integer> getCurrentDivArchitectureId(String tabId);

	public List<String> getBackupOfDocuments(String backupName, String company_name, String username, String format, String folderPath);
	
	public List<String> getBackupOfProcesses(String backupName, String company_name, String username, String format, String folderPath);
	...
	HashMap<String, String> getObjectNameWithDeleteStatus(String dbName, String tableName, String nameAttributeSGV,
			String architectureID);

	List<HashMap<String, String>> getRows1WithOutStatusCheck(String dbName, String tableName, String attrName,String architecture_id);

	List<graphFolders> getGraphFoldersWithStatus(String foreignKey, String username, String status,
			String company_name);

	List<graphFiles> getGraphNamesFromFolderWithStatus(String username, String parent_id, String graphStatus,
			String company_name);

	List<matrixFiles> getMatrixNamesFromFolderWithStatus(String username, String parent_id, String MatrixStatus,
			String company_name);

	List<catalogFiles> getCatalogNamesFromFolderWithStatus(String username, String parent_id, String CatalogStatus,
			String company_name);

	List<navigationFiles> getNavigationNamesFromFolderWithStatus(String username, String parent_id, String navStatus,
			String company_name);

	List<timeLineGraph> getRoadMapFromFolderWithStatus(String username, String parent_id, String roadMapStatus,
			String company_name);

	String getObjectIdByObjectNameAndArchitectureID(String dbName, String tableName, String objectName,
			String architectureID);

	List<ArrayList<String>> AllRowsDataToEvolveRepositoryInDB(String dbName, String elementName, List<String> columns, String architecture_id,String insertedArchitectureID, HttpSession session);

	HashMap<String, String> insertEvolveArchitectureData(String dbName, String tableName, List<String> columnNames,
			List<ArrayList<String>> columnValues, String username, HttpSession session, Schema unif)
			throws SQLException;

	List<RelationsModel> getRelationshipTableForEvolveRepository(String dbName, String architechtureId,HashMap<String, String> idsAndObjectNames, HashMap<String, HashMap<String, String>> allInsertedObjectNameToID);

	int evolveArchitectureInsertRelationships(String dbName, List<ArrayList<String>> columnValues);


	List<addRowsModel> listRowsWithArchitectureId(String dbName, String tableName, String attrName,
			String architectureId);

	List<addRowsModel> getRowsForTypeWithAchitectureId(String dbName, String tableName, String attrName,
			String condition, String type, String architectureId);

	List<ArrayList<String>> AllRelationshipObjectRowsDataToEvolveRepositoryInDB(String dbName, String elementName,
			List<String> columns, String architecture_id,String insertedArchitectureID,String fromColumnSGV,String toColumnSGV,HashMap<String, String>idsAndObjectName,HashMap<String, String> shortNameToElementName,HashMap<String, HashMap<String, String>> allInsertedObjectNameToID);

	int insertEvolveArchitectureRelationshipObjectsAndModelsData(String dbName, String tableName,
			List<String> columnNames, List<ArrayList<String>> columnValues) throws SQLException;

	List<ArrayList<String>> AllRowsCatalog_Matrix_Roadmap_DataToEvolveRepositoryInDB(String dbName, String elementName,
			List<String> columns, String architecture_id, String insertedArchitectureID,String insertedFolderID);

	public List<ArrayList<String>> AllRowsDaigram_Navigation_DataToEvolveRepositoryInDB(String string, String string2,
			List<String> roadmapTableColumns, String repositoryID, String insertedArchitectureID, String insertedFolderID,HashMap<String, String>idsAndObjectName,HashMap<String, String> shortNameToElementName,HashMap<String, HashMap<String, String>> allInsertedObjectNameToID);
	...
	HashMap<String, String> getGraphXML_And_idsToNameDict(String dbName, String username, String graphID, String company_name);

	HashMap<String, String> getNavigationXML_And_idsToNameDict(String dbName, String username, String navID,
			String company_name);

	HashMap<String, HashMap<String, String>> deleteRelationshipObjects(String dbName, String relationships,String row_id);
	...
	int insertNewToken(String getID, String token);
	...
	HashMap<String, HashMap<String, String>> updateStatusToZeroOrOneRelationshipObjects(String dbName, String relationships,
			String row_id,String status);

	public String getUserIDFromToken(String tokenID);

	int restoreRelObj(String dbName, String tableName, String ul_id, List<Element> elementsObject);

	String checkGraphObjects(String dbName, String tableName, String object_name, String architecture_id);


	List<String> getAllRelationshipOverloadTextWithBrCodeCheck(String dbName, String element, String sourceOrTarget,
			String sourceOrTargetValue, String relationshipType, String brCode);

	String get_old_password(String password);

	List<String> getOldPasswordForMatch(String dbName, String tableName, String user_id, String attName);

	List<String> getSessionIDStatus(String sessionId);


	int insertUsersInLdapUsers(String[] usernames, String status);

	public List<Map<String, String>> getLdapUsers();

	String checkLdapUserExistOrNot(String username);

	int updateLdapUserPassword(String username, String password);

	public String checkUserExistOrNot(String username);


	List<Integer> getMatrixId(String matrix_name, String matrix_element1, String matrix_element2,
			String matrix_relation, String parentID, String username, String architecture_id, String companyName);

	List<String> getCatalogId(String catalog_name, String archtectureId);

	List<String> getMatrixId(String matrixName, String archtectureId);

	List<String> getRoadMapName(String roadMapId);

	List<String> getLdapAdmin();
