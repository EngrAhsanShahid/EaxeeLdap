...
public class homeController {
	...
	public ModelAndView home(ModelAndView model,HttpSession session) throws JAXBException, FileNotFoundException {
		...
		int createSessionActiveUserTable = enterpriseDAO.createSessionActiveUserTable(sessionId,username);
		int updateSessionActiveUserTable = enterpriseDAO.updateSessionActiveUserTable(sessionId,username);
