...
public class matrixFiles {
	...
	public matrixFiles(String id, String modelName, String parentID, String matrix_name, String matrix_element1,
			String matrix_element2, String matrix_relation, String status) {
		this.id = id;
	...
	public matrixFiles(String id, String matrix_name, String matrix_element1, String matrix_element2, String matrix_relation,String parentID, String status) {
		this.id = id;
		this.parentID = parentID;
		this.matrix_name = matrix_name;
		this.matrix_element1 = matrix_element1;
	...
	public String toString() {
		return "matrixFiles [id=" + id + ", modelName=" + modelName + ", parentID=" + parentID + ", matrix_name="
				+ matrix_name + ", matrix_element1=" + matrix_element1 + ", matrix_element2=" + matrix_element2
				+ ", matrix_relation=" + matrix_relation + ", status=" + status + "]";
	}
